...
const Register = () => {
      ...
      if (res.data.success) {
        updateUserProfile(data.name, res.data.data.display_url)
          .then(() => {
            ...
            axiosPublicly.post("/users", userInfo).then((res) => {
              if (res.data._id) {
                reset();
                logout();
                setRegistered(true);
  ...
  return (
    <div>
      {/* Role Selection */}
      <div className="flex flex-row items-center space-x-1 mt-5 mb-4">
        {["Teacher", "Student", "Admin"].map((role) => (
          <button
            ...
            className={`btn w-40 ${
              selectedRole === role ? "btn-primary" : "btn-outline"
            }`}
          >
            {role}
          </button>
      ...
      <div className="bg-base-200 max-w-96 mx-auto text-gray-700">
        <div className="hero-content">
          <div className="card bg-base-100 w-full shadow-2xl">
            <form
              className="card-body pb-0 relative"
            ...
            <p className="text-center pb-5">
              ...
              <span className="text-blue-700 font-semibold">
                <button onClick={() => setRegistered(true)}>Sign In</button>
              </span>
            </p>

            <button
              // className="absolute right-[37px] top-[236px] py-2"
              className="absolute right-[37px] top-[196px] py-2"
              onClick={() => setVisible(!visible)}
            >
              {visible ? (
                <IoMdEyeOff className="text-2xl text-gray-400" />
              ) : (
...
//             >
//               {visible ? (
//                 <IoMdEyeOff className="text-2xl text-gray-400"></IoMdEyeOff>
//               ) : (
//                 <IoEye className="text-gray-400 text-2xl"></IoEye>
//               )}
//             </button>
//           </div>
//         </div>
